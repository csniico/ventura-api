...
export class AppointmentController {
  ...
  async create(@Req() req: AuthedRequest, @Body() dto: CreateAppointmentDto) {
    ...
    return this.appointmentService.create(businessId, req.user.userId, dto);
  }
  ...
  async list(
    ...
    const businessId = await this.resolveBusinessId(req);
    return this.appointmentService.list(businessId, from, to);
  }
  ...
  async getById(@Req() req: AuthedRequest, @Param('id') id: string) {
    const businessId = await this.resolveBusinessId(req);
    return this.appointmentService.getById(businessId, id);
  }
  ...
  async delete(@Req() req: AuthedRequest, @Param('id') id: string) {
    const businessId = await this.resolveBusinessId(req);
    return this.appointmentService.delete(businessId, id);
  }
}
